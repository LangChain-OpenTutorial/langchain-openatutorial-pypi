...
setup(
    ...
    description="A package for LangChain open tutorial features.",  # 패키지에 대한 간단한 설명
    author="BAEM1N",  # 패키지 작성자 이름
    author_email="baemin.dev@gmail.com",  # 패키지 작성자 이메일
    url="https://github.com/baem1n/langchain_opentutorial",  # 패키지의 홈페이지 URL
